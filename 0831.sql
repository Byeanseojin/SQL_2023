...
select * from book
         where price < 15000;
-- 가격이 10000원 이상 16000 이하인 도서를 검색하시오.
select * from book
         where price between 10000 and 20000;
-- 가격이 10000원 이상 16000 이하인 도서를 검색하시오.(단, between and를 사용하지 마시오.)
select * from book
        where price>=10000 and price<= 16000;
-- book테이블에서 출판사가 굿스포츠, 해냄, 웅진지식하우스인 도서를 검색하시오.(단, in 연산자를 사용하시오.)
select * from book 
         where publisher in('굿스포츠','해냄','웅진지식하우스');
-- book테이블에서 출판사가 굿스포츠, 해냄, 웅진지식하우스인 도서를 검색하시오.(단, in 연산자를 사용하지마시오./ 비교연산자와 or 연산자 사용)
select * from book
         where publisher='굿스포츠' or publisher='해냄' or publisher='웅진지식하우스';
-- book테이블에서 출판사가 굿스포츠, 해냄, 웅진지식하우스가 아닌 도서를 검색하시오.(단, not in연산자를 사용하시오.)
select * from book
         where publisher not in('굿스포츠','해냄','웅진지식하우스');
-- book테이블에서 출판사가 굿스포츠, 해냄, 웅진지식하우스가 아닌 도서를 검색하시오.(단, 비교연산자 or 연산자 사용)
select * from book
